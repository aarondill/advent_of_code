...
public class Part1 {
  ...
  public static void main(String[] args) throws FileNotFoundException {
    ...
    System.out.println(desiredPatterns.stream().parallel().filter(p -> isPossible(p, availablePatterns))
        .peek(p -> System.out.println(p)).count());
  }
  ...
  private static boolean isPossible(String design, List<String> patterns) {
    ...
    return lcm.get(design.length()) > 0;
  }
}
